<template>
  <div class="container">
    ...
    <div class="example">
     <div class="bundle">
       <p class="p20">Bundle 1</p>
       <p class="p21"><fa class="fa" icon="globe" />Jiangsu Province</p>
     </div>
     <div class="origin">
       <p>Products origin: </p>
       <div class="flags">
        <img src="../../static/south1.png" alt="">
        <img src="../../static/japan.png" alt="">
        <img src="../../static/germany.png" alt="">
        <img src="../../static/taiwan.png" alt="">
        <img src="../../static/united1.png" alt="">
       </div>
     </div>
     <div class="see_more"
...
export default {
  ...
  async fetch() {
    ...
    const Data = await this.$axios
      .get(
        'https://api.airtable.com/v0/app3WmB2b7AQQ6Ufv/B1Summer?api_key=keyvkxyqdCw2v2FEK'
      )
      .then((el) => {
