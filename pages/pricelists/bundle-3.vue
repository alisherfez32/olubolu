...
export default {
  ...
  async fetch() {
    ...
    const Data = await this.$axios
      .get(
        'https://api.airtable.com/v0/app3WmB2b7AQQ6Ufv/B3Carol?api_key=keyvkxyqdCw2v2FEK'
      )
      .then((el) => {
  ...
  methods: {
    ...
    showMsgOk(image) {
       if(image){
        ...
        // Using HTML string
        const titleVNode = h('div', { domProps: { innerHTML: '<b>Item`s image</b>' } })
